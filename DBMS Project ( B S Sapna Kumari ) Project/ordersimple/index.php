							...
							?>
								<div class="col-md-3">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<img src="<?php if($prow['photo']==''){echo "upload/noimage.jpg";} else{echo $prow['photo'];} ?>" height="225px;" width="80%">
										</div>
										<div class="panel-footer text-center">
...
<footer><center>DONE BY : B S SAPNA KUMARI (1DT17CS113)</center></footer>
</html>